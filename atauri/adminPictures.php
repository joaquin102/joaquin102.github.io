...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="adminPicturesCSS.css"> 
        ...
        <div class="leftPanel">
            ...
            <div class="insideTopPanel">
                <ul>
                    ...
                    <li><img src="Images/video.png">Imagenes</span></li>
...
<div class="breakingflow"></div>
    ...
    <script type="text/javascript" src="aPicturesJQ.js"></script>
